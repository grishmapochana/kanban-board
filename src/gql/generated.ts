...
/** User account information. Don't modify its structure as Hasura Auth relies on it to function properly. */
export type UsersCards_AggregateArgs = {
  distinct_on?: InputMaybe<Array<Cards_Select_Column>>;
  limit?: InputMaybe<Scalars['Int']['input']>;
  offset?: InputMaybe<Scalars['Int']['input']>;
  order_by?: InputMaybe<Array<Cards_Order_By>>;
...
export const CreateCardDocument = gql`
    mutation CreateCard($columnId: uuid!, $name: String!, $userId: uuid!, $position: float8!) {
  insert_cards_one(
    object: {column_id: $columnId, name: $name, user_id: $userId, position: $position}
  ) {
    id
    name
    position
...
export const UpdateCardDocument = gql`
  ...
  update_cards_by_pk(pk_columns: {id: $id}, _set: {name: $name, user_id: $userId}) {
    id
    name
    user_id
  }
